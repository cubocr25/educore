 ...
 * entidad de dominio (Empleado, Edificio, Seccion...) al JSON que consume el
 * frontend, y viceversa. No tiene lógica de negocio ni reemplaza al modelo:
 * Empleado sigue siendo la clase real con sus reglas; el DTO solo "aplana" lo
 * necesario para una respuesta HTTP. Por eso cada recurso tiene dos: un
 * `...Request` (lo que llega del cliente al crear/actualizar) y un `...Dto` (lo
 * que se devuelve).
 */
public final class Dtos {
    ...
    public record EdificioDto(
        ...
        public static List<EdificioDto> listaDesde(
