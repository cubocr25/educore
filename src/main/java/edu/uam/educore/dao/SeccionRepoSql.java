...
public class SeccionRepoSql extends Repositorio<Seccion> {
  ...
  public void guardar(Seccion seccion) throws Exception {
    ...
    String sql =
        "INSERT INTO seccion " + "(codigo, nombre, aula_id, docente_id) " + "VALUES (?, ?, ?, ?)";
  ...
  public void guardarMatricula(int seccionId, int estudianteId) throws Exception {
  ...
  public void eliminarMatricula(int seccionId, int estudianteId) throws Exception {
  ...
  public void actualizar(Seccion seccion) throws Exception {
    ...
    String sql =
        "UPDATE seccion " + "SET codigo=?, nombre=?, aula_id=?, docente_id=? " + "WHERE id=?";
  ...
  public Optional<Seccion> buscarPorId(int id) throws Exception {
    ...
    String sql = "SELECT id, codigo, nombre, aula_id, docente_id " + "FROM seccion WHERE id=?";
  ...
  public List<Seccion> buscarTodos() throws Exception {
    ...
    String sql = "SELECT id, codigo, nombre, aula_id, docente_id " + "FROM seccion ORDER BY id";
  ...
  private Seccion mapearSeccion(ResultSet rs) throws Exception {
    ...
    Seccion seccion = new Seccion(id, codigo, nombre, aula, docente);
  ...
  private Estudiante crearEstudiante(ResultSet rs) throws Exception {
    ...
    if ("BECADO".equalsIgnoreCase(tipo)) {
      ...
      double porcentajeBeca = rs.getDouble("porcentaje_beca");

      return new EstudianteBecado(id, nombre, apellidos, email, carnet, porcentajeBeca);
    }
  ...
  private Aula buscarAula(int aulaId) throws Exception {
    ...
    String sql = "SELECT id, numero, capacidad, tipo, edificio_id " + "FROM aula WHERE id=?";
