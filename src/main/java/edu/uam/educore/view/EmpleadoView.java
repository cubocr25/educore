...
public class EmpleadoView extends VistaBase {
  ...
  private void registrar() {
    ...
    try {
      ...
      Empleado empleado =
          controller.registrar(nombre, apellidos, email, salario, LocalDate.parse(fecha), tipo);

      mostrarMensaje("Registrado - ID: " + empleado.getId() + "\n" + empleado.getInfo());
    ...
    try {
      ...
      Empleado actualizado =
          controller.actualizar(
              id, nombre, apellidos, email, salario, LocalDate.parse(fecha), tipo);
